...
> **Beta setup**
>
> Run the published beta image only when you want to test preview functionality before the next stable release.
...
Run the beta installation command again after pulling the new image.
...
<details>
<summary><strong>Build the beta branch from source</strong></summary>
