...
def test_playlist_actions_are_compact_responsive_and_accessible() -> None:
    ...
    assert '/static/action-controls.css?v=6' in html
    assert '/static/action-controls.js?v=3' in html
    assert html.index('/static/playlist-refine.js?v=7') < html.index('/static/action-controls.js?v=3')
...
def test_library_uses_open_for_drafts_and_published_playlists() -> None:
    ...
    assert '/static/action-controls.js?v=3' in html
    assert html.index('/static/library.js?v=15') < html.index('/static/action-controls.js?v=3')
