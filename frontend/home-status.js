(() => {
  ...
  function createFooter() {
    ...
    footer.setAttribute('aria-label', 'Service configuration status');
    footer.innerHTML = `
      <div class="footer-indicators">
        <button
          id="footer-ai-status"
          class="footer-indicator ai pending"
          type="button"
        ...
        <button
          id="footer-youtube-status"
          class="footer-indicator youtube pending"
          type="button"
  ...
  function bindIndicatorActions() {
    $('footer-ai-status')?.addEventListener('click', () => openSettings('ai'));
    $('footer-youtube-status')?.addEventListener('click', () => openSettings('youtube'));
  }
  ...
  async function refreshStatus() {
    createFooter();
    const aiIndicator = $('footer-ai-status');
    const youtubeIndicator = $('footer-youtube-status');
